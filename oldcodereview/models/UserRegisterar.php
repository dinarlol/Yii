<?php
class UserRegisterar extends Person{
	public $avatar = 'avatar.png';
	public $image_directory = 'user_images';
	...
	public function afterSave()
	{
		...
		*/
		...
		Thank you for registering to Akimbo. Please confirm your email address by
	...
	public function init(){
		...
		$criteria->compare('name', $this->userRole);
