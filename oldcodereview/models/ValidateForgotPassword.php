...
/**
 * This is the model class for table "ak_validate_forgot_pass".
 *
 * The followings are the available columns in table 'ak_validate_forgot_pass':
 ...
 */
class ValidateForgotPassword extends CActiveRecord
{
	 ...
	 * @return ValidateForgotPassword the static model class
	 */
	...
	{
		return 'ak_validate_forgot_pass';
	}
	...
	public function afterSave(){
		...
		$subject = "Forgot Password Request - Akimbo";
		$body = '
		<html>
		<head>
		...
		Akimbo had recieved a request for forgot password from ip '. $this->ip.'. Please  <a href="'. $this->validationEmailLink.'"> click here to reset </a>
		reset the password.<br/> This link will be valide for one day<br/>
