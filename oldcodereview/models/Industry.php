...
/**
 * This is the model class for table "ak_industry".
 *
 * The followings are the available columns in table 'ak_industry':
 * @property integer $id
...
class Industry extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'companys' => array(self::HAS_MANY, 'Company', 'industry_id'),
			'userLookingFors' => array(self::HAS_MANY, 'UserLookingFor', 'industry_id'),
		);
	}
