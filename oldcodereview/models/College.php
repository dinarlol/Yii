...
/**
 * This is the model class for table "ak_college".
 *
 * The followings are the available columns in table 'ak_college':
 * @property integer $id
...
class College extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
				'collegeTeams' => array(self::BELONGS_TO, 'CollegeTeams', 'id'),
		);
	}
