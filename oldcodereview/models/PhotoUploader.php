...
/**
 * This is the model class for table "ak_photo_uploader".
 *
 * The followings are the available columns in table 'ak_photo_uploader':
 * @property string $id
 ...
 */
class PhotoUploader extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return PhotoUploader the static model class
	 */
