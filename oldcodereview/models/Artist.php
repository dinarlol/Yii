...
/**
 * This is the model class for table "ak_artist".
 *
 * The followings are the available columns in table 'ak_artist':
 * @property integer $id
...
class Artist extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'userMusics' => array(self::HAS_MANY, 'UserMusic', 'artist_id'),
		);
	}
