 ...
 * @since 1.1
 */
class AkimboSearchView extends CBaseListView
{
	...
	public function init()
	{
		...
		if(!isset($this->htmlOptions['class']))
			$this->htmlOptions['class']='tab_container';
	...
	protected function createDataColumn($text)
	{
		...
		$column=new SearchViewColumn($this);
			 	...
			 	*/
			 	...
			 	//echo "<tbody>\n";
			 		...
			 		for($row=0;$row<$n;++$row){
			 			...
			 			if($this->categoryHeading !== $data->category_id){
			 				echo '<li class="li">'.$data->category->description." </li>";
			 				$this->categoryHeading = $data->category_id;
 ...
 ';
			 		...
			 		*/
			 		...
			 		{
			 		$data=$this->dataProvider->data[$row];
			 		echo '<li class="'.$this->evaluateExpression($this->rowCssClassExpression,array('row'=>$row,'data'=>$data)).'">';
			 		}
