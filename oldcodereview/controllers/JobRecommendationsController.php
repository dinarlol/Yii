...
class JobRecommendationsController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('JobRecommendations');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='job-recommendations-form')
		{
