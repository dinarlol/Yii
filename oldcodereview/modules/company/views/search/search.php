...
<?php echo CHtml::link('Click To Search','#adv',array('class'=>'search-button','id'=>'newid')); ?>
<div class="search-form" style="display:none" id="adv">
<?php $this->renderPartial('_companysearch',array(
	'model'=>$model,
)); ?>
</div><!-- search-form -->
	...
	'columns'=>array(
			...
			*/
			...
			array(
					...
					'value'=>'empty($data->userDetails->avatar)?$data->role->name==$data->userRole?"<a href=\"index.php?r=employee/profile&id=".$data->id."\"><img width=\"55\" height=\"54\" class=\"avatar\" src=\"images/avatar.png\"></a>":"":"<a href=\"index.php?r=employee/profile&id=".$data->id."\"><img width=\"55\" height=\"54\" class=\"avatar\" src=\"images/".$data->userDetails->avatar."\"></a>"',
			...
			array(
					...
					'value'=>'empty($data->companys->companyDetails->logo)?$data->role->name==$data->companyRole?"<a href=\"index.php?r=employee/profile&id=".$data->id."\"><img width=\"55\" height=\"54\" class=\"avatar\" src=\"images/company_logo.png\"></a>":"":"<a href=\"index.php?r=employee/profile&id=".$data->id."\"><img width=\"55\" height=\"54\" class=\"avatar\" src=\"images/".$data->companys->companyDetails->logo."\"></a>"',
			...
			array(
					'type' => 'raw',
					'name'=>'id',
					'value'=>'empty($data->id)?"":"<span class=\"mini_btn\">
    <ul>
    <li><a href=\"index.php?r=employee/profile&id=".$data->id."\">contact</a></li>
    <li><a href=\"index.php?r=employee/profile&id=".$data->id."\">Profile</a></li>
    </ul></span>
					"',
