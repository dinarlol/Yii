	...
	'columns'=>array(
			...
			*/
			...
			array(
					'type' => 'raw',
					'name'=>'job_title',
					'value'=>'empty($data->job_title)?"":"<span class=\"name\"><h3><a id=\"user_contact".$data->id."\" href=\"index.php?r=company/jobs/view&id=".$data->id."\">".$data->job_title."</a></h3></span>"',
			),
...
'value'=>'CHtml::ajaxLink("Send Message", Yii::app()->createAbsoluteUrl("company/jobs/sendMessage",array("id"=>$data->user_id,"jobId"=>$data->job->id)),array("update"=>"#send-job-message-div"))'
	...
	*/		
    ...
    <ul>
    <li><a id=\"user_contact".$data->id."\" href=\"index.php?r=company/jobs/update&id=".$data->id."\">Edit</a></li>
    <li><a id=\"user_profile".$data->id."\" href=\"index.php?r=company/jobs/update&id=".$data->id."\">Delete</a></li>
    </ul></span>":"<span class=\"mini_btn\">
    <ul>
    <li><a id=\"job_recommend".$data->id."\"  onclick=\"$(\'#job-recomendations-dialog\').dialog(\'open\');$(\'#job_id\').val(\'".$data->id."\');\"   href=\"#\" >Recommend</a></li>
     <li id=\"job_watch_update_".$data->id."\">".CHtml::ajaxLink("Watch", Yii::app()->createAbsoluteUrl("company/jobs/watch",array("id"=>$data->id)),array("update"=>"#job_watch_update_".$data->id))."
        				</li>
					</ul></span>"',
