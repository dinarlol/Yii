...
start_row();
 ...
 leave_emp_list_cells(_("Select Employee "), 'emp_id', null, _("Employee List"));
...
{
	return get_emp_leave_balance($_POST['emp_id']); 
}
...
/*function edit_link($row)
{
	return pager_link(_("View"),
			"/payroll/advert_view.php?trans_no=" . $row["emp_id"], ICON_GL);
}
*/
$sql = get_search_emp_leave($emp_id);
