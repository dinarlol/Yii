...
{
	$outstanding_only = 0;
	page(_($help_context = "Approved Training  Inquiry "), false, false, "", $js);
}
//-----------------------------------------------------------------------------------
// Ajax updates
//
...
{
	return get_hr_loan_balance($_POST['id']); 
}
...
function edit_link($row)
{
	return pager_link(_("Edit"),
			"/payroll/hr_training_approvement.php?trans_no=" . $row["id"], ICON_EDIT);
}
echo $_POST['l_type'];
echo $_POST['id'];
$sql = get_aprove_hr_training2($_POST['id']);
//echo $sql;
