...
{
	$outstanding_only = 0;
	page(_($help_context = "Search Employee Annual leaves "), false, false, "", $js);
}
//-----------------------------------------------------------------------------------
// Ajax updates
//
...
leave_emp_list_cells(_("Select Employee :"), 'emp_id', null, _("Employee Name"));
leave_type_list_cells(_("Select Leave type :"), 'type', 'AL', _("Leave type"),false,true,true);
...
?>
<a style="cursor:pointer; margin-left:98px; " onclick="window.print()">Print</a>
<?
