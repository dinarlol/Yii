...
{
	$outstanding_only = 0;
	page(_($help_context = "Applicant Inquiry"), false, false, "", $js);
}
//-----------------------------------------------------------------------------------
// Ajax updates
//
...
{
	return get_app_inquiry_balance($_POST['id']); 
}
...
function edit_link($row)
{
	return pager_link(_("View"),
			"/payroll/test_view.php?trans_no=" . $row["ap_id"], ICON_VIEW);
}

$sql = get_aprove_app_inquiry($emp_id);
