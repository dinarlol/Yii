...
{
	$outstanding_only = 0;
	page(_($help_context = "New Employee Inquiry "), false, false, "", $js);
}
//-----------------------------------------------------------------------------------
// Ajax updates
//
...
function edit_link($row)
{
	return pager_link(_("Edit"),
			"/payroll/manage/employee.php?trans_no=" . $row["ap_id"], ICON_GL);
}

$sql = get_newemp($emp_id);
