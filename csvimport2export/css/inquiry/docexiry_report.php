...
} elseif (get_post('id'))
{
	$disable = get_post('id') !== '';
		...
		$Ajax->addDisable(true, 'id', $disable);
...
leave1_doc_list_cells(_("Select Doc :"),'id', null,_("Doc Name"));
...
{
	return get_leave_balance($_POST['id']); 
}
...
echo $date333;*/
$sql = get_search_expiredoc($_POST['id']);
//echo  $_POST['id'];
