...
/**
 * This is the model class for table "t_stage".
 *
 * The followings are the available columns in table 't_stage':
...
class Stage extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('stage_id, stage', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'commissions' => array(self::HAS_MANY, 'Commission', 'stage_id'),
		);
	}
